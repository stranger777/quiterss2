...
QT_MOC_LITERAL(1, 15, 24), // "showAuthenticationDialog"
QT_MOC_LITERAL(2, 40, 0), // ""
QT_MOC_LITERAL(3, 41, 6) // "server"

    },
    "NetworkManager\0showAuthenticationDialog\0"
    "\0server"
};
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->showAuthenticationDialog((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkManager::showAuthenticationDialog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NetworkManager::showAuthenticationDialog(const QString & _t1)
{
